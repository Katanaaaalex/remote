...
Для начала необходимо создать аккаунт на сайте `github.com`.
Затем нужно создать новый репозиторий и выполнять команды последовательно в терминале. Команды предложены при создании нового репозитория. Если мы вносим изменения в репозиторий, то вводим команду `git push`. Изменения автоматически обновляются в удаленном репозитории. 