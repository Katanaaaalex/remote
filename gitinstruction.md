...
`git checkout master` - вернуттться к актуальному состоянию, затем продолжить работееу

`git diff`- показать разницу между теоокущим файлом и закоммиченным файлом.
